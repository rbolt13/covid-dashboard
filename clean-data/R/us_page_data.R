...
us_page_data <- function(us_totals){
  # Arrange Data
  # by case
  ...
  least_p <- arr_totals_p[[52,1]]
  least_p_val <- base::round(
    arr_totals_p[[52,3]]*100,
    digits = 2)
  ...
  least_dp <- arr_totals_dp[[52,1]]
  least_dp_val <- base::round(
    arr_totals_dp[[52,5]]*100,
    digits = 2)
